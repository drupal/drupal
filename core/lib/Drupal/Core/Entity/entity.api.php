 ...
 * - Routes can be automatically generated by providing a route handler.
 *   See @ref sec_routes. Otherwise, define routes and links for the various
 *   URLs associated with the entity. These go into the 'links' annotation, with
 *   the link type as the key, and the path of this link template as the value.
 *   The corresponding route requires the following route name:
 ...
 *   may also refer to a 'uri_callback' function, which is used as a fallback
 *   when a 'links' annotation entry cannot be found for a requested link type.
 *   This function takes an object of the entity interface you have defined as
 *   its parameter, and returns a URL object for the entity page. This feature
 *   is deprecated and is only used when link templates are not provided.
