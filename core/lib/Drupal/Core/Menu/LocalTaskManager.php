  ...
  public function getLocalTasks($route_name, $level = 0) {
    if (!isset($this->taskData[$route_name])) {
      ...
      if (!$this->requestStack->getCurrentRequest()->attributes->has('exception')) {
        ...
        $this->moduleHandler->alterDeprecated('Deprecated in drupal:9.3.0 and is removed from drupal:10.0.0. Use menu_local_tasks_render instead. See https://www.drupal.org/node/3216578.', 'menu_local_tasks', $this->taskData[$route_name], $route_name, $cacheability);
