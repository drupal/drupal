...
/**
 * This file was generated via php core/scripts/generate-proxy-class.php 'Drupal\Core\Lock\BatchDatabaseLockBackend' "core/lib/Drupal/Core".
 */

namespace Drupal\Core\ProxyClass\Lock {

    /**
     * Provides a proxy class for \Drupal\Core\Lock\BatchDatabaseLockBackend.
     *
     * @see \Drupal\Component\ProxyBuilder
     */
    class BatchDatabaseLockBackend implements \Drupal\Core\Lock\LockBackendInterface
    {
         ...
         *
         * @var \Drupal\Core\Lock\BatchDatabaseLockBackend
         */
        protected $service;
