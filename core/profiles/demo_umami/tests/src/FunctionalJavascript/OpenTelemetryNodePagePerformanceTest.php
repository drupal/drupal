...
class OpenTelemetryNodePagePerformanceTest extends PerformanceTestBase {
  ...
  protected function testNodePageWarmCache(): void {
    ...
    $expected_queries = [
      ...
      'SELECT "taxonomy_term_field_data"."tid" AS "tid", "taxonomy_term_field_data"."langcode" AS "langcode", "taxonomy_term__parent"."parent_target_id" AS "parent_target_id", "taxonomy_term__parent"."delta" AS "parent_delta" FROM "taxonomy_term_field_data" "taxonomy_term_field_data" LEFT OUTER JOIN "taxonomy_term__parent" "taxonomy_term__parent" ON "taxonomy_term__parent"."entity_id" = "taxonomy_term_field_data"."tid" AND "taxonomy_term__parent"."langcode" = "taxonomy_term_field_data"."langcode" AND "taxonomy_term__parent"."deleted" = 0 WHERE ("taxonomy_term_field_data"."tid" IN (31)) AND ("taxonomy_term_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "taxonomy_term_field_data"."tid" AS "tid", "taxonomy_term_field_data"."langcode" AS "langcode", "taxonomy_term__parent"."parent_target_id" AS "parent_target_id", "taxonomy_term__parent"."delta" AS "parent_delta" FROM "taxonomy_term_field_data" "taxonomy_term_field_data" LEFT OUTER JOIN "taxonomy_term__parent" "taxonomy_term__parent" ON "taxonomy_term__parent"."entity_id" = "taxonomy_term_field_data"."tid" AND "taxonomy_term__parent"."langcode" = "taxonomy_term_field_data"."langcode" AND "taxonomy_term__parent"."deleted" = 0 WHERE ("taxonomy_term_field_data"."tid" IN (22)) AND ("taxonomy_term_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "node_field_data"."nid" AS "nid", "node_field_data"."langcode" AS "langcode", "node__field_cooking_time"."field_cooking_time_value" AS "field_cooking_time_value", "node__field_difficulty"."field_difficulty_value" AS "field_difficulty_value", "node__field_media_image"."field_media_image_target_id" AS "field_media_image_target_id", "node__field_number_of_servings"."field_number_of_servings_value" AS "field_number_of_servings_value", "node__field_preparation_time"."field_preparation_time_value" AS "field_preparation_time_value", "node__field_recipe_instruction"."field_recipe_instruction_value" AS "field_recipe_instruction_value", "node__field_recipe_instruction"."field_recipe_instruction_format" AS "field_recipe_instruction_format", "node__field_summary"."field_summary_value" AS "field_summary_value", "node__field_summary"."field_summary_format" AS "field_summary_format" FROM "node_field_data" "node_field_data" LEFT OUTER JOIN "node__field_cooking_time" "node__field_cooking_time" ON "node__field_cooking_time"."entity_id" = "node_field_data"."nid" AND "node__field_cooking_time"."langcode" = "node_field_data"."langcode" AND "node__field_cooking_time"."deleted" = 0 LEFT OUTER JOIN "node__field_difficulty" "node__field_difficulty" ON "node__field_difficulty"."entity_id" = "node_field_data"."nid" AND "node__field_difficulty"."langcode" = "node_field_data"."langcode" AND "node__field_difficulty"."deleted" = 0 LEFT OUTER JOIN "node__field_media_image" "node__field_media_image" ON "node__field_media_image"."entity_id" = "node_field_data"."nid" AND "node__field_media_image"."langcode" = "node_field_data"."langcode" AND "node__field_media_image"."deleted" = 0 LEFT OUTER JOIN "node__field_number_of_servings" "node__field_number_of_servings" ON "node__field_number_of_servings"."entity_id" = "node_field_data"."nid" AND "node__field_number_of_servings"."langcode" = "node_field_data"."langcode" AND "node__field_number_of_servings"."deleted" = 0 LEFT OUTER JOIN "node__field_preparation_time" "node__field_preparation_time" ON "node__field_preparation_time"."entity_id" = "node_field_data"."nid" AND "node__field_preparation_time"."langcode" = "node_field_data"."langcode" AND "node__field_preparation_time"."deleted" = 0 LEFT OUTER JOIN "node__field_recipe_instruction" "node__field_recipe_instruction" ON "node__field_recipe_instruction"."entity_id" = "node_field_data"."nid" AND "node__field_recipe_instruction"."langcode" = "node_field_data"."langcode" AND "node__field_recipe_instruction"."deleted" = 0 LEFT OUTER JOIN "node__field_summary" "node__field_summary" ON "node__field_summary"."entity_id" = "node_field_data"."nid" AND "node__field_summary"."langcode" = "node_field_data"."langcode" AND "node__field_summary"."deleted" = 0 WHERE ("node_field_data"."nid" IN (3, 6, 7, 10)) AND ("node_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      'SELECT "node_field_data"."nid" AS "nid", "node_field_data"."langcode" AS "langcode", "node__field_ingredients"."field_ingredients_value" AS "field_ingredients_value", "node__field_ingredients"."delta" AS "field_ingredients_delta", "node__field_recipe_category"."field_recipe_category_target_id" AS "field_recipe_category_target_id", "node__field_recipe_category"."delta" AS "field_recipe_category_delta", "node__field_tags"."field_tags_target_id" AS "field_tags_target_id", "node__field_tags"."delta" AS "field_tags_delta", "node__layout_builder__layout"."layout_builder__layout_section" AS "layout_builder__layout_section", "node__layout_builder__layout"."delta" AS "layout_builder__layout_delta" FROM "node_field_data" "node_field_data" LEFT OUTER JOIN "node__field_ingredients" "node__field_ingredients" ON "node__field_ingredients"."entity_id" = "node_field_data"."nid" AND "node__field_ingredients"."langcode" = "node_field_data"."langcode" AND "node__field_ingredients"."deleted" = 0 LEFT OUTER JOIN "node__field_recipe_category" "node__field_recipe_category" ON "node__field_recipe_category"."entity_id" = "node_field_data"."nid" AND "node__field_recipe_category"."langcode" = "node_field_data"."langcode" AND "node__field_recipe_category"."deleted" = 0 LEFT OUTER JOIN "node__field_tags" "node__field_tags" ON "node__field_tags"."entity_id" = "node_field_data"."nid" AND "node__field_tags"."langcode" = "node_field_data"."langcode" AND "node__field_tags"."deleted" = 0 LEFT OUTER JOIN "node__layout_builder__layout" "node__layout_builder__layout" ON "node__layout_builder__layout"."entity_id" = "node_field_data"."nid" AND "node__layout_builder__layout"."langcode" = "node_field_data"."langcode" AND "node__layout_builder__layout"."deleted" = 0 WHERE ("node_field_data"."nid" IN (3, 6, 7, 10)) AND ("node_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "media_field_data"."mid" AS "mid", "media_field_data"."langcode" AS "langcode", "media__field_media_image"."field_media_image_target_id" AS "field_media_image_target_id", "media__field_media_image"."field_media_image_alt" AS "field_media_image_alt", "media__field_media_image"."field_media_image_title" AS "field_media_image_title", "media__field_media_image"."field_media_image_width" AS "field_media_image_width", "media__field_media_image"."field_media_image_height" AS "field_media_image_height" FROM "media_field_data" "media_field_data" LEFT OUTER JOIN "media__field_media_image" "media__field_media_image" ON "media__field_media_image"."entity_id" = "media_field_data"."mid" AND "media__field_media_image"."langcode" = "media_field_data"."langcode" AND "media__field_media_image"."deleted" = 0 WHERE ("media_field_data"."mid" IN (21)) AND ("media_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "media_field_data"."mid" AS "mid", "media_field_data"."langcode" AS "langcode", "media__field_media_image"."field_media_image_target_id" AS "field_media_image_target_id", "media__field_media_image"."field_media_image_alt" AS "field_media_image_alt", "media__field_media_image"."field_media_image_title" AS "field_media_image_title", "media__field_media_image"."field_media_image_width" AS "field_media_image_width", "media__field_media_image"."field_media_image_height" AS "field_media_image_height" FROM "media_field_data" "media_field_data" LEFT OUTER JOIN "media__field_media_image" "media__field_media_image" ON "media__field_media_image"."entity_id" = "media_field_data"."mid" AND "media__field_media_image"."langcode" = "media_field_data"."langcode" AND "media__field_media_image"."deleted" = 0 WHERE ("media_field_data"."mid" IN (7)) AND ("media_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "media_field_data"."mid" AS "mid", "media_field_data"."langcode" AS "langcode", "media__field_media_image"."field_media_image_target_id" AS "field_media_image_target_id", "media__field_media_image"."field_media_image_alt" AS "field_media_image_alt", "media__field_media_image"."field_media_image_title" AS "field_media_image_title", "media__field_media_image"."field_media_image_width" AS "field_media_image_width", "media__field_media_image"."field_media_image_height" AS "field_media_image_height" FROM "media_field_data" "media_field_data" LEFT OUTER JOIN "media__field_media_image" "media__field_media_image" ON "media__field_media_image"."entity_id" = "media_field_data"."mid" AND "media__field_media_image"."langcode" = "media_field_data"."langcode" AND "media__field_media_image"."deleted" = 0 WHERE ("media_field_data"."mid" IN (6)) AND ("media_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
      ...
      'SELECT "media_field_data"."mid" AS "mid", "media_field_data"."langcode" AS "langcode", "media__field_media_image"."field_media_image_target_id" AS "field_media_image_target_id", "media__field_media_image"."field_media_image_alt" AS "field_media_image_alt", "media__field_media_image"."field_media_image_title" AS "field_media_image_title", "media__field_media_image"."field_media_image_width" AS "field_media_image_width", "media__field_media_image"."field_media_image_height" AS "field_media_image_height" FROM "media_field_data" "media_field_data" LEFT OUTER JOIN "media__field_media_image" "media__field_media_image" ON "media__field_media_image"."entity_id" = "media_field_data"."mid" AND "media__field_media_image"."langcode" = "media_field_data"."langcode" AND "media__field_media_image"."deleted" = 0 WHERE ("media_field_data"."mid" IN (3)) AND ("media_field_data"."langcode" IN ("en", "es", "und", "zxx"))',
