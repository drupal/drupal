...
class OpenTelemetryNodePagePerformanceTest extends PerformanceTestBase {
  ...
  protected function testNodePageCoolCache(): void {
    ...
    $expected_queries = [
      ...
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "core.base_field_override.taxonomy_term.recipe_category.tid", "core.base_field_override.taxonomy_term.recipe_category.uuid", "core.base_field_override.taxonomy_term.recipe_category.revision_id", "core.base_field_override.taxonomy_term.recipe_category.langcode", "core.base_field_override.taxonomy_term.recipe_category.vid", "core.base_field_override.taxonomy_term.recipe_category.revision_created", "core.base_field_override.taxonomy_term.recipe_category.revision_user", "core.base_field_override.taxonomy_term.recipe_category.revision_log_message", "core.base_field_override.taxonomy_term.recipe_category.status", "core.base_field_override.taxonomy_term.recipe_category.name", "core.base_field_override.taxonomy_term.recipe_category.uuid"0, "core.base_field_override.taxonomy_term.recipe_category.uuid"1, "core.base_field_override.taxonomy_term.recipe_category.uuid"2, "core.base_field_override.taxonomy_term.recipe_category.uuid"3, "core.base_field_override.taxonomy_term.recipe_category.uuid"4, "core.base_field_override.taxonomy_term.recipe_category.uuid"5, "core.base_field_override.taxonomy_term.recipe_category.uuid"6, "core.base_field_override.taxonomy_term.recipe_category.uuid"7, "core.base_field_override.taxonomy_term.recipe_category.uuid"8, "core.base_field_override.taxonomy_term.recipe_category.uuid"9, "core.base_field_override.taxonomy_term.recipe_category.revision_id"0, "core.base_field_override.taxonomy_term.recipe_category.revision_id"1 )',
      ...
      'SELECT "base"."uid" AS "uid", "base"."uuid" AS "uuid", "base"."langcode" AS "langcode" FROM "users" "base" WHERE "base"."uid" IN (6)',
      'SELECT "data".* FROM "users_field_data" "data" WHERE "data"."uid" IN (6) ORDER BY "data"."uid" ASC',
      'SELECT "t".* FROM "user__roles" "t" WHERE ("entity_id" IN (6)) AND ("deleted" = 0) AND ("langcode" IN ("en", "es", "und", "zxx")) ORDER BY "delta" ASC',
      'SELECT "t".* FROM "user__user_picture" "t" WHERE ("entity_id" IN (6)) AND ("deleted" = 0) AND ("langcode" IN ("en", "es", "und", "zxx")) ORDER BY "delta" ASC',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "core.date_format.medium" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "language.en" AND "name" IN ( "core.date_format.medium" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "core.date_format.long" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "language.en" AND "name" IN ( "core.date_format.long" )',
      ...
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "core.date_format.umami_dates" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "language.en" AND "name" IN ( "core.date_format.umami_dates" )',
      ...
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "responsive_image.styles.3_2_image" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "language.en" AND "name" IN ( "responsive_image.styles.3_2_image" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "image.style.large_3_2_768x512", "image.style.large_3_2_2x", "image.style.medium_3_2_2x", "image.style.medium_3_2_600x400" )',
      'SELECT "name", "data" FROM "config" WHERE "collection" = "language.en" AND "name" IN ( "image.style.large_3_2_768x512", "image.style.large_3_2_2x", "image.style.medium_3_2_2x", "image.style.medium_3_2_600x400" )',
      ...
      'SELECT "name", "data" FROM "config" WHERE "collection" = "" AND "name" IN ( "core.base_field_override.content_moderation_state.content_moderation_state.id", "core.base_field_override.content_moderation_state.content_moderation_state.uuid", "core.base_field_override.content_moderation_state.content_moderation_state.revision_id", "core.base_field_override.content_moderation_state.content_moderation_state.langcode", "core.base_field_override.content_moderation_state.content_moderation_state.uid", "core.base_field_override.content_moderation_state.content_moderation_state.workflow", "core.base_field_override.content_moderation_state.content_moderation_state.moderation_state", "core.base_field_override.content_moderation_state.content_moderation_state.content_entity_type_id", "core.base_field_override.content_moderation_state.content_moderation_state.content_entity_id", "core.base_field_override.content_moderation_state.content_moderation_state.content_entity_revision_id", "core.base_field_override.content_moderation_state.content_moderation_state.uuid"0, "core.base_field_override.content_moderation_state.content_moderation_state.uuid"1, "core.base_field_override.content_moderation_state.content_moderation_state.uuid"2 )',
      'SELECT "revision"."vid" AS "vid", "revision"."langcode" AS "langcode", "revision"."revision_uid" AS "revision_uid", "revision"."revision_timestamp" AS "revision_timestamp", "revision"."revision_log" AS "revision_log", "revision"."revision_default" AS "revision_default", "base"."nid" AS "nid", "base"."type" AS "type", "base"."uuid" AS "uuid", CASE "base"."vid" WHEN "revision"."vid" THEN 1 ELSE 0 END AS "isDefaultRevision" FROM "node" "base" INNER JOIN "node_revision" "revision" ON "revision"."nid" = "base"."nid" AND "revision"."vid" IN (75)',
      'SELECT "revision".* FROM "node_field_revision" "revision" WHERE ("revision"."vid" IN (75)) AND ("revision"."vid" IN ("75")) ORDER BY "revision"."vid" ASC',
      'SELECT "t".* FROM "node_revision__field_cooking_time" "t" WHERE ("revision_id" IN ("75")) AND ("deleted" = 0) AND ("langcode" IN ("en", "es", "und", "zxx")) ORDER BY "delta" ASC',
      'SELECT "t".* FROM "node_revision__field_difficulty" "t" WHERE ("revision_id" IN ("75")) AND ("deleted" = 0) AND ("langcode" IN ("en", "es", "und", "zxx")) ORDER BY "delta" ASC',
      ...
      'SELECT "name", "route", "fit" FROM "router" WHERE "pattern_outline" IN ( "/recipes" ) AND "number_parts" >= 1',
      ...
      'INSERT INTO "semaphore" ("name", "value", "expire") VALUES ("library_info:umami:Drupal\Core\Cache\CacheCollector", "LOCK_ID", "EXPIRE")',
      'DELETE FROM "semaphore"  WHERE ("name" = "library_info:umami:Drupal\Core\Cache\CacheCollector") AND ("value" = "LOCK_ID")',
    ];
    $recorded_queries = $performance_data->getQueries();
    $this->assertSame($expected_queries, $recorded_queries);
    $this->assertSame(190, $performance_data->getQueryCount());
    $this->assertSame(265, $performance_data->getCacheGetCount());
    $this->assertSame(66, $performance_data->getCacheSetCount());
    $this->assertSame(0, $performance_data->getCacheDeleteCount());
    $this->assertSame(73, $performance_data->getCacheTagChecksumCount());
    $this->assertSame(87, $performance_data->getCacheTagIsValidCount());
