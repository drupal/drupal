...
class OpenTelemetryNodePagePerformanceTest extends PerformanceTestBase {
  ...
  protected function testNodePageWarmCache(): void {
    ...
    $expected_queries = [
      ...
      'SELECT "node_field_data".*, "node_field_data"."langcode" AS "node_field_data__langcode", "node__field_ingredients"."field_ingredients_value" AS "field_ingredients_value", "node__field_ingredients"."delta" AS "field_ingredients_delta", "node__field_recipe_category"."field_recipe_category_target_id" AS "field_recipe_category_target_id", "node__field_recipe_category"."delta" AS "field_recipe_category_delta", "node__field_tags"."field_tags_target_id" AS "field_tags_target_id", "node__field_tags"."delta" AS "field_tags_delta", "node__layout_builder__layout"."layout_builder__layout_section" AS "layout_builder__layout_section", "node__layout_builder__layout"."delta" AS "layout_builder__layout_delta" FROM "node_field_data" "node_field_data" LEFT OUTER JOIN "node__field_ingredients" "node__field_ingredients" ON "node__field_ingredients"."entity_id" = "node_field_data"."nid" AND "node__field_ingredients"."langcode" = "node_field_data"."langcode" AND "node__field_ingredients"."deleted" = 0 LEFT OUTER JOIN "node__field_recipe_category" "node__field_recipe_category" ON "node__field_recipe_category"."entity_id" = "node_field_data"."nid" AND "node__field_recipe_category"."langcode" = "node_field_data"."langcode" AND "node__field_recipe_category"."deleted" = 0 LEFT OUTER JOIN "node__field_tags" "node__field_tags" ON "node__field_tags"."entity_id" = "node_field_data"."nid" AND "node__field_tags"."langcode" = "node_field_data"."langcode" AND "node__field_tags"."deleted" = 0 LEFT OUTER JOIN "node__layout_builder__layout" "node__layout_builder__layout" ON "node__layout_builder__layout"."entity_id" = "node_field_data"."nid" AND "node__layout_builder__layout"."langcode" = "node_field_data"."langcode" AND "node__layout_builder__layout"."deleted" = 0 WHERE "node_field_data"."nid" IN (1)',
      ...
      'SELECT "taxonomy_term_field_data".*, "taxonomy_term_field_data"."langcode" AS "taxonomy_term_field_data__langcode", "taxonomy_term__parent"."parent_target_id" AS "parent_target_id", "taxonomy_term__parent"."delta" AS "parent_delta" FROM "taxonomy_term_field_data" "taxonomy_term_field_data" LEFT OUTER JOIN "taxonomy_term__parent" "taxonomy_term__parent" ON "taxonomy_term__parent"."entity_id" = "taxonomy_term_field_data"."tid" AND "taxonomy_term__parent"."langcode" = "taxonomy_term_field_data"."langcode" AND "taxonomy_term__parent"."deleted" = 0 WHERE "taxonomy_term_field_data"."tid" IN (31)',
      ...
      'SELECT "node_field_data".*, "node_field_data"."langcode" AS "node_field_data__langcode", "node__field_ingredients"."field_ingredients_value" AS "field_ingredients_value", "node__field_ingredients"."delta" AS "field_ingredients_delta", "node__field_recipe_category"."field_recipe_category_target_id" AS "field_recipe_category_target_id", "node__field_recipe_category"."delta" AS "field_recipe_category_delta", "node__field_tags"."field_tags_target_id" AS "field_tags_target_id", "node__field_tags"."delta" AS "field_tags_delta", "node__layout_builder__layout"."layout_builder__layout_section" AS "layout_builder__layout_section", "node__layout_builder__layout"."delta" AS "layout_builder__layout_delta" FROM "node_field_data" "node_field_data" LEFT OUTER JOIN "node__field_ingredients" "node__field_ingredients" ON "node__field_ingredients"."entity_id" = "node_field_data"."nid" AND "node__field_ingredients"."langcode" = "node_field_data"."langcode" AND "node__field_ingredients"."deleted" = 0 LEFT OUTER JOIN "node__field_recipe_category" "node__field_recipe_category" ON "node__field_recipe_category"."entity_id" = "node_field_data"."nid" AND "node__field_recipe_category"."langcode" = "node_field_data"."langcode" AND "node__field_recipe_category"."deleted" = 0 LEFT OUTER JOIN "node__field_tags" "node__field_tags" ON "node__field_tags"."entity_id" = "node_field_data"."nid" AND "node__field_tags"."langcode" = "node_field_data"."langcode" AND "node__field_tags"."deleted" = 0 LEFT OUTER JOIN "node__layout_builder__layout" "node__layout_builder__layout" ON "node__layout_builder__layout"."entity_id" = "node_field_data"."nid" AND "node__layout_builder__layout"."langcode" = "node_field_data"."langcode" AND "node__layout_builder__layout"."deleted" = 0 WHERE "node_field_data"."nid" IN (3, 6, 7, 10)',
      ...
      'SELECT "file_managed".*, "file_managed"."langcode" AS "file_managed__langcode" FROM "file_managed" "file_managed" WHERE "file_managed"."fid" IN (41)',
      ...
      'SELECT "file_managed".*, "file_managed"."langcode" AS "file_managed__langcode" FROM "file_managed" "file_managed" WHERE "file_managed"."fid" IN (13)',
      ...
      'SELECT "file_managed".*, "file_managed"."langcode" AS "file_managed__langcode" FROM "file_managed" "file_managed" WHERE "file_managed"."fid" IN (11)',
      ...
      'SELECT "file_managed".*, "file_managed"."langcode" AS "file_managed__langcode" FROM "file_managed" "file_managed" WHERE "file_managed"."fid" IN (5)',
