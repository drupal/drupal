...
class ComplexWorkflowTypeTest extends KernelTestBase {
  ...
  public function testLoadMultipleByType() {
    $workflow1 = Workflow::create(['id' => 'test1', 'type' => 'workflow_type_complex_test'], 'workflow');
    $workflow1->save();
    $workflow2 = Workflow::create(['id' => 'test2', 'type' => 'workflow_type_complex_test'], 'workflow');
    $workflow2->save();
    $workflow3 = Workflow::create(['id' => 'test3', 'type' => 'workflow_type_test'], 'workflow');
    $workflow3->save();
