...
/**
 * @file
 * Contains \Drupal\migrate_drupal\Tests\Table\d7\FieldRevisionFieldLink.
 *
...
/**
 * Generated file to represent the field_revision_field_link table.
 */
class FieldRevisionFieldLink extends DrupalDumpBase {

  public function load() {
    $this->createTable("field_revision_field_link", array(
      'primary key' => array(
        'entity_type',
        'deleted',
        'entity_id',
