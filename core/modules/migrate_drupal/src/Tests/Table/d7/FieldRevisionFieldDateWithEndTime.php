...
/**
 * @file
 * Contains \Drupal\migrate_drupal\Tests\Table\d7\FieldRevisionFieldDateWithEndTime.
 *
...
/**
 * Generated file to represent the field_revision_field_date_with_end_time table.
 */
class FieldRevisionFieldDateWithEndTime extends DrupalDumpBase {

  public function load() {
    $this->createTable("field_revision_field_date_with_end_time", array(
      'primary key' => array(
        'entity_type',
        'deleted',
        'entity_id',
