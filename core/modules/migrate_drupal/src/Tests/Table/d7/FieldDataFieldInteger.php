...
/**
 * Generated file to represent the field_data_field_integer table.
 */
class FieldDataFieldInteger extends DrupalDumpBase {

  public function load() {
    $this->createTable("field_data_field_integer", array(
      'primary key' => array(
        'entity_type',
        'deleted',
        'entity_id',
