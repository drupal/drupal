...
/**
 * @file
 * Contains \Drupal\migrate_drupal\Tests\Table\d7\FieldRevisionFieldImages.
 *
...
/**
 * Generated file to represent the field_revision_field_images table.
 */
class FieldRevisionFieldImages extends DrupalDumpBase {

  public function load() {
    $this->createTable("field_revision_field_images", array(
      'primary key' => array(
        'entity_type',
        'deleted',
        'entity_id',
