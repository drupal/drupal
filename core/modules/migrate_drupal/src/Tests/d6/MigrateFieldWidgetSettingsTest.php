...
class MigrateFieldWidgetSettingsTest extends MigrateDrupal6TestBase {
  ...
  public function testWidgetSettings() {
    ...
    $this->assertIdentical($component, $expected, 'Text field settings are correct.');
    ...
    $this->assertIdentical($component['type'], 'link_default');
    $this->assertIdentical($component['weight'], 7);
