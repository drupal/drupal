...
class DateTimeItemTest extends FieldKernelTestBase {
  ...
  public function testDateTime() {
    ...
    $this->assertInstanceOf(FieldItemListInterface::class, $entity->field_datetime, 'Field implements interface.');
    $this->assertInstanceOf(FieldItemInterface::class, $entity->field_datetime[0], 'Field item implements interface.');
