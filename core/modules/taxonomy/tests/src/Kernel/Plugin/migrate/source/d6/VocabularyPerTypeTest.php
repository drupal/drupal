...
use Drupal\taxonomy\Plugin\migrate\source\d6\VocabularyPerType;
 ...
 *
 * @legacy-covers \Drupal\taxonomy\Plugin\migrate\source\d6\VocabularyPerType
 */
#[CoversClass(VocabularyPerType::class)]
#[Group('taxonomy')]
