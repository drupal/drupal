...
class NumberFieldTest extends WebDriverTestBase {
  ...
  public function testNumberFormatter() {
    ...
    $this->assertSession()->pageTextContains("$prefix$float_formatted$suffix");
    $this->assertSession()->pageTextContains((string) $random_integer);
    ...
    $this->assertSession()->pageTextContains($integer_formatted);
  }
