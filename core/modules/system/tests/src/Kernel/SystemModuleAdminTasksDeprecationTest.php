...
class SystemModuleAdminTasksDeprecationTest extends KernelTestBase {
  ...
  public function testSystemGetModuleAdminTasksDeprecation(): void {
    $this->expectDeprecation("system_get_module_admin_tasks() is deprecated in drupal:9.3.0 and is removed from drupal:10.0.0. the 'system.module_admin_tasks_helper' service with the getModuleAdminTasks() method instead. See https://www.drupal.org/node/3038972");
