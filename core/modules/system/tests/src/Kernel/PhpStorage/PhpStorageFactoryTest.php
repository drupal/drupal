...
class PhpStorageFactoryTest extends KernelTestBase {
  ...
  public function testGetNoSettings() {
    ...
    $this->assertInstanceOf(MTimeProtectedFileStorage::class, $php, 'An MTimeProtectedFileStorage instance was returned with no settings.');
  }
  ...
  public function testGetDefault() {
    $this->setSettings();
    $php = PhpStorageFactory::get('test');
    $this->assertInstanceOf(MockPhpStorage::class, $php, 'A FileReadOnlyStorage instance was returned with default settings.');
  }
  ...
  public function testGetOverride() {
    ...
    $this->assertInstanceOf(MockPhpStorage::class, $php, 'A MockPhpStorage instance was returned from overridden settings.');

    // Test that the name is used for the bin when it is NULL.
    $this->setSettings('test', ['bin' => NULL]);
    $php = PhpStorageFactory::get('test');
    $this->assertInstanceOf(MockPhpStorage::class, $php, 'An MockPhpStorage instance was returned from overridden settings.');
    ...
    $php = PhpStorageFactory::get('test');
    $this->assertInstanceOf(MTimeProtectedFileStorage::class, $php, 'An MTimeProtectedFileStorage instance was returned from overridden settings with no class.');
