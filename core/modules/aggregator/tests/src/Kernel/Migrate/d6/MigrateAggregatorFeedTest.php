...
class MigrateAggregatorFeedTest extends MigrateDrupal6TestBase {
  ...
  public function testAggregatorFeedImport() {
    ...
    $this->assertSame(900, (int) $feed->refresh->value);
    $this->assertSame(1387659487, (int) $feed->checked->value);
    $this->assertSame(0, (int) $feed->queued->value);
    ...
    $this->assertSame(0, (int) $feed->modified->value);
  }
