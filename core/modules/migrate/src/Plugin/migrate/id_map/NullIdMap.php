...
class NullIdMap extends PluginBase implements MigrateIdMapInterface {
  ...
  public function prepareUpdate() {
    @trigger_error('NullIdMap::prepareUpdate() is deprecated in drupal:9.2.0 and is removed from drupal:10.0.0. Use \Drupal\migrate\Plugin\MigrateIdMapInterface::setUpdate() with no parameter instead. See https://www.drupal.org/node/3188673', E_USER_DEPRECATED);
  }
