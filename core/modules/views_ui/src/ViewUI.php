  ...
  public function getStandardButtons(&$form, FormStateInterface $form_state, $form_id, $name = NULL) {
    ...
    if (!$form_state->get('ok_button')) {
      ...
      if (isset($names)) {
        ...
        $form['actions']['submit']['#process'] = array_merge([[ViewsUiTrustedFormCallbacks::class, 'formButtonClicked']], \Drupal::service('element_info')->getInfoProperty($form['actions']['submit']['#type'], '#process', []));
      }
