...
namespace Drupal\search_node\Plugin\Search;
...
class SearchNode extends ConfigurableSearchPluginBase implements AccessibleInterface, SearchIndexingInterface, TrustedCallbackInterface {
   ...
   *
   * @param \Drupal\Core\Database\Query\ExtendableInterface $query
