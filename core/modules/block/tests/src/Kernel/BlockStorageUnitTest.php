...
class BlockStorageUnitTest extends KernelTestBase {
  ...
  public function testBlockCRUD() {
    $this->assertInstanceOf(ConfigEntityStorage::class, $this->controller, 'The block storage is loaded.');
  ...
  protected function createTests() {
    ...
    $this->assertInstanceOf(Block::class, $entity, 'The newly created entity is a Block.');
    ...
    $this->assertInstanceOf(TestHtmlBlock::class, $entity->getPlugin(), 'The entity has an instance of the correct block plugin.');
  }
  ...
  protected function loadTests() {
    ...
    $this->assertInstanceOf(Block::class, $entity, 'The loaded entity is a Block.');
