...
class FileItemTest extends FieldKernelTestBase {
  ...
  public function testFileItem() {
    ...
    $this->assertInstanceOf(FieldItemListInterface::class, $entity->file_test, 'Field implements interface.');
    $this->assertInstanceOf(FieldItemInterface::class, $entity->file_test[0], 'Field item implements interface.');
