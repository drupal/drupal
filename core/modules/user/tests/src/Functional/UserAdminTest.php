...
class UserAdminTest extends BrowserTestBase {
  ...
  public function testUserAdmin() {
    ...
    $this->assertSession()->elementNotExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_a->getAccountName() . '")]');
    $this->assertSession()->elementExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_b->getAccountName() . '")]');
    $this->assertSession()->elementExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_c->getAccountName() . '")]');
    ...
    $this->assertSession()->elementNotExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_a->getAccountName() . '")]');
    $this->assertSession()->elementNotExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_b->getAccountName() . '")]');
    $this->assertSession()->elementExists('xpath', '//td[contains(@class, "views-field-name") and contains(text(), "' . $user_c->getAccountName() . '")]');
