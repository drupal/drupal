 ...
 * @group user
 */
class RegistrationWithUserFieldsTest extends JavascriptTestBase {
  ...
  public function testRegistrationWithUserFields() {
    ...
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:core.entity_form_display.user.user.register');
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:user.settings');
  ...
  protected function assertRegistrationFormCacheTagsWithUserFields() {
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:core.entity_form_display.user.user.register');
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:field.field.user.user.test_user_field');
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:field.storage.user.test_user_field');
    $this->webAssert->responseHeaderContains('X-Drupal-Cache-Tags', 'config:user.settings');
  }
