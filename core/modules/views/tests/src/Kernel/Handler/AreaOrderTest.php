...
class AreaOrderTest extends ViewsKernelTestBase {
  ...
  public function testAreaOrder(): void {
    ...
    $position_powered = strpos($output, 'block-id-stark-powered');
    $position_branding = strpos($output, 'block-id-stark-branding');

    $this->assertNotEquals(0, $position_powered, 'ID stark-powered found.');
    $this->assertNotEquals(0, $position_branding, 'ID stark-branding found');
