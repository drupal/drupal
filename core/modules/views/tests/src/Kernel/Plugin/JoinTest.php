...
class JoinTest extends RelationshipJoinTestBase {
  ...
  public function testExamplePlugin() {
    ...
    $this->assertInstanceOf(JoinTestPlugin::class, $join, 'The correct join class got loaded.');
  ...
  public function testBasePlugin() {
    ...
    $this->assertInstanceOf(JoinPluginBase::class, $join, 'The correct join class got loaded.');
