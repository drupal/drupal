...
class DisplayKernelTest extends ViewsKernelTestBase {
  ...
  public function testGetPlugin() {
    ...
    $this->assertInstanceOf(AccessPluginBase::class, $display_handler->getPlugin('access'), 'An access plugin instance was returned.');
    $this->assertInstanceOf(CachePluginBase::class, $display_handler->getPlugin('cache'), 'A cache plugin instance was returned.');
    $this->assertInstanceOf(ExposedFormPluginInterface::class, $display_handler->getPlugin('exposed_form'), 'An exposed_form plugin instance was returned.');
    $this->assertInstanceOf(PagerPluginBase::class, $display_handler->getPlugin('pager'), 'A pager plugin instance was returned.');
    $this->assertInstanceOf(QueryPluginBase::class, $display_handler->getPlugin('query'), 'A query plugin instance was returned.');
    $this->assertInstanceOf(RowPluginBase::class, $display_handler->getPlugin('row'), 'A row plugin instance was returned.');
    $this->assertInstanceOf(StylePluginBase::class, $display_handler->getPlugin('style'), 'A style plugin instance was returned.');
