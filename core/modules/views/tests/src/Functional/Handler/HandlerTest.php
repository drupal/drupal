  ...
  public function testAccess() {
    ...
    foreach ($views_data['access_callback'] as $type => $info) {
      if (!in_array($type, ['title', 'help'])) {
        $this->assertInstanceOf(HandlerBase::class, $view->field['access_callback'], 'Make sure the user got access to the access_callback field ');
    ...
    foreach ($views_data['access_callback'] as $type => $info) {
      if (!in_array($type, ['title', 'help'])) {
        ...
        $this->assertInstanceOf(HandlerBase::class, $view->field['access_callback_arguments'], 'Make sure the user got access to the access_callback_arguments field ');
      }
    }
  }
