...
class LinkItemSerializationTest extends FieldKernelTestBase {
  ...
  public function testLinkDeserialization(): void {
    ...
    $this->expectExceptionMessageIs('The generic FieldItemNormalizer cannot denormalize string values for "options" properties of the "field_test" field (field item class: Drupal\link\Plugin\Field\FieldType\LinkItem).');
