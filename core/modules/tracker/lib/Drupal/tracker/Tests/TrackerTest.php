...
class TrackerTest extends WebTestBase {
  ...
  function testTrackerUser() {
    ...
    $this->drupalPost('comment/reply/node/' . $other_published_my_comment->id() . '/comment', $comment, t('Save'));
  ...
  function testTrackerCronIndexing() {
    ...
    $this->drupalPost('comment/reply/node/' . $nodes[3]->id() . '/comment', $comment, t('Save'));
