...
class JavascriptStatesTest extends WebDriverTestBase {
  ...
  protected function doCheckboxTriggerTests(): void {
    ...
    // itself.
    $radios_all_disabled_value1 = $this->getNodeElementsByXpath(
    ...
    $radios_all_disabled_value2 = $this->getNodeElementsByXpath(
      '//input[@name=:name][@value=:value]',
    ...
    $radios_some_disabled_value1 = $this->getNodeElementsByXpath(
      '//input[@name=:name][@value=:value]',
    ...
    $radios_some_disabled_value2 = $this->getNodeElementsByXpath(
      '//input[@name=:name][@value=:value]',
