...
trait DeprecationListenerTrait {
  ...
  public static function isDeprecationSkipped($message) {
    ...
    $dynamic_skipped_deprecations = [
      ...
      // PHP 8.1.
      '%Implicit conversion from float \d+\.\d+ to int loses precision%',
    ];
  ...
  public static function getSkippedDeprecations() {
    return [
      ...
      'DateTime::setTimestamp(): Passing null to parameter #1 ($timestamp) of type int is deprecated',
      'Declaration of Twig\Markup::jsonSerialize() should be compatible with JsonSerializable::jsonSerialize(): mixed',
      ...
      'imagejpeg(): Passing null to parameter #3 ($quality) of type int is deprecated',
      ...
      'mb_substr(): Passing null to parameter #2 ($start) of type int is deprecated',
      'openlog(): Passing null to parameter #1 ($prefix) of type string is deprecated',
      'openlog(): Passing null to parameter #3 ($facility) of type int is deprecated',
      ...
      'stripslashes(): Passing null to parameter #1 ($string) of type string is deprecated',
      'strip_tags(): Passing null to parameter #1 ($string) of type string is deprecated',
      'strlen(): Passing null to parameter #1 ($string) of type string is deprecated',
      'strnatcasecmp(): Passing null to parameter #1 ($string1) of type string is deprecated',
      ...
      'str_word_count(): Passing null to parameter #1 ($string) of type string is deprecated',
