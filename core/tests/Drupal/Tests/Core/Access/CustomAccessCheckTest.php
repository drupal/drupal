...
class CustomAccessCheckTest extends UnitTestCase {
  ...
  public function testAccess() {
    ...
    $this->controllerResolver->expects($this->at(0))
      ...
      ->willReturn([new TestController(), 'accessDeny']);
