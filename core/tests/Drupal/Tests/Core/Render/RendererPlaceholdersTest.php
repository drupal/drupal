...
class RendererPlaceholdersTest extends RendererTestBase {
  ...
  public function testInvalidLazyBuilder(): void {
    ...
    $this->expectExceptionMessageIs('The #lazy_builder property must have an array as a value.');
  ...
  public function testInvalidLazyBuilderArguments(): void {
    ...
    $this->expectException(\AssertionError::class);
    $this->expectExceptionMessageIs('The #lazy_builder property must have an array as a value, containing two values: the callback, and the arguments for the callback.');
    $this->renderer->renderRoot($element);
  }
  ...
  public function testNonScalarLazyBuilderCallbackContext(): void {
    ...
    $this->expectException(\AssertionError::class);
    $this->expectExceptionMessageIs("A #lazy_builder callback's context may only contain scalar values or NULL.");
    $this->renderer->renderRoot($element);
  }
  ...
  public function testChildrenPlusBuilder(): void {
    ...
    $this->expectException(\AssertionError::class);
    $this->expectExceptionMessageIs('When a #lazy_builder callback is specified, no children can exist; all children must be generated by the #lazy_builder callback. You specified the following children: child_a, child_b.');
    $this->renderer->renderRoot($element);
  }
  ...
  public function testPropertiesPlusBuilder(): void {
    ...
    $this->expectException(\AssertionError::class);
    $this->expectExceptionMessageIs('When a #lazy_builder callback is specified, no properties can exist; all properties must be generated by the #lazy_builder callback. You specified the following properties: #llama, #piglet.');
    $this->renderer->renderRoot($element);
  }
  ...
  public function testCreatePlaceholderPropertyWithoutLazyBuilder(): void {
    ...
    $this->expectExceptionMessageIs('When #create_placeholder is set, a #lazy_builder callback must be present as well.');
    $this->renderer->renderRoot($element);
  }
  ...
  public function testNonArrayReturnFromLazyBuilder(): void {
    ...
    $this->expectExceptionMessageIs("#lazy_builder callbacks must return a valid renderable array, got boolean from \Drupal\Tests\Core\Render\PlaceholdersTest::callbackNonArrayReturn");
    $this->renderer->renderRoot($element);
  }
