...
class InstallerExtensionListDeprecationTest extends UnitTestCase {
  ...
  /**
   * Tests the installer theme engine extension list deprecation.
   */
  public function testInstallerThemeEngineExtensionListDeprecation(): void {
    $this->expectUserDeprecationMessage('Drupal\Core\Installer\InstallerThemeEngineExtensionList is deprecated in drupal:11.5.0 and is removed from drupal:13.0.0. Use Drupal\Core\Extension\ThemeEngineExtensionList instead. See https://www.drupal.org/node/3577846');
    $this->assertTrue(class_exists('Drupal\Core\Installer\InstallerThemeEngineExtensionList'));
  }
