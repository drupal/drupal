...
class TestSetupTraitTest extends KernelTestBase {
  ...
  public function testGetDatabaseConnection(): void {
    $this->expectDeprecation('Drupal\Core\Test\TestSetupTrait::getDatabaseConnection is deprecated in drupal:9.1.0 and is removed from drupal:10.0.0. There is no replacement. See https://www.drupal.org/node/3176816');
