...
use Drupal\router_test\Controller\TestTitleClosureAttributes;
use Drupal\router_test\Controller\TestTitleClosureAttributesPhp85;
...
class TitleClosureTest extends KernelTestBase {
  ...
  public function testTitleClosureRoundTrip(): void {
    ...
    $this->assertSame(
      [TestTitleClosureAttributesPhp85::class, 'titleClosure', 0],
  ...
  public function testRepeatedAttributesHaveOwnTitles(): void {
    ...
    $this->assertSame(
      [TestTitleClosureAttributesPhp85::class, 'titleClosure', 1],
      $route->getDefault('_title_closure'),
    );
  ...
  public function testStaleReference(): void {
    ...
    $this->expectExceptionMessageIs('There is no Route attribute at index 2 on ' . TestTitleClosureAttributes::class . '::titleClosure().');
    Route::getTitleClosure(TestTitleClosureAttributes::class, 'titleClosure', 2);
  }
