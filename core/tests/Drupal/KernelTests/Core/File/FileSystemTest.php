...
class FileSystemTest extends KernelTestBase {
  ...
  public function testDestinationDirectoryFailureOnCopy(): void {
    ...
    $this->expectExceptionMessageIs("The specified file 'public://test.txt' could not be copied because the destination directory 'public://subdirectory' is not properly configured. This may be caused by a problem with file or directory permissions.");
